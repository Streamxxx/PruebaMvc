      ...
      <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
        ...
        <div class="form-outline mb-4 text-center mt-5">
          ...
          <div class="form-outline mb-4">
            <input type="email" id="form1Example13" class="form-control form-control-lg" placeholder="Ingresar aqui"/>
            <label class="form-label" for="form1Example13">Nombre de usuario</label>
          </div>

          <!-- Password input -->
          <div class="form-outline mb-4">
            <input type="password" id="form1Example23" class="form-control form-control-lg" placeholder="*******" />
...
<!--pagina codea para modelo mvc VIDEO 14
    -->